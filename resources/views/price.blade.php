...
<section class="price-rule-txt" role="region" aria-labelledby="price-rules">
    ...
    <p class="rule-txt">- Les inscriptions se font au moment des cours, elles sont possibles tout au long de l'année.</p>
    <p class="rule-txt">- Tarifs dégressifs en fonction du trimestre d'inscription, les tarifs comprennent 36€ pour la licence.</p>
    ...
    <p class="rule-txt">- Pour les 17 ans dispositif "Pass Sport" (de septembre au 31 octobre 2021).</p>
