...
<section id="activity-box-1" class="activity-box ">
    ...
    <p class="activity-txt">Mouvements coordonnés à la respiration, postures, enchaînements de postures, relaxation....
    </p>
...
<section id="activity-box-4" class="activity-box ">
    ...
    <img class="activity-img" src="{{ asset('asset/img/pilates.png') }}" alt="pilates">
    <p class="activity-txt">Au centre sportif de la haie-Vigné.</p>
    <div class="pilate-content">
        <div class="pilate-left">
            <h4>4 cours :</h4>
    ...
    <p class="activity-txt">Méthode de remise en forme globale basée sur des excercices doux aynat pour objectif de
        renforcer les muscles profons essentiels à une bonne posture.</p>
...
<section id="activity-box-3" class="activity-box ">
    ...
    <p class="activity-txt">Renforcement musculaire (abdos, fessiers...) enchaînements dansés pour certains cours,
...
<section id="activity-box-5" class="activity-box ">
    ...
    <p class="activity-txt">Le stretching permet d'étirer les différents muscles ou groupes musculaires du corps et
        d'assouplir les articulations. De ce fait, il préserve contre les traumatismes musculaires et articulaires.</p>
...
<section id="activity-box-2" class="activity-box ">
    ...
    <img class="activity-img" src="{{ asset('asset/img/gym.png') }}" alt="gym">
    ...
    <p class="activity-txt">Entretien de la condition physique, souplesse, force musculaire, stimulation de la mémoire et de l'équilibre.</p>
